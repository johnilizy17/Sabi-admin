        ...
        <div className={`d-print-none ${s.root}`}>
          ...
          <Nav className="ml-md-0">
            ...
            >
              ...
              <Link to="sent" style={{align:"start"}}>
                <DropdownItem  style={{width:"100%"}}>             
                    <Badge color="danger">
                      <i className="fa fa-bell-o" />
                    </Badge>
                    <div className={s.details} style={{width:"88px"}}>Sent</div>
                </DropdownItem>
                </Link>
                ...
                <DropdownItem >
                  ...
                  <div className={s.details}>Send notification</div>
                </DropdownItem>
                </Link>
                <Link to="draft">
                <DropdownItem>
                  ...
                  <div className={s.details} style={{width:"88px"}}>
                    Draft
                  </div>
                </DropdownItem>
                </Link>
                ...
                <DropdownItem>
                  {/* eslint-disable-next-line */}
                  <a href="#" className="text-white">
                    Notification history <ArrowIcon className={s.headerIcon} maskName="bellArrow" />
                  </a>
                </DropdownItem>
                </Link>
              </DropdownMenu>
