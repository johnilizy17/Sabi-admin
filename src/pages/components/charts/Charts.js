  ...
  render() {
    return (
      <section className={`${s.root} mb-4`}>
        <h1 className="page-title"> <span className="fw-semi-bold">Federal Legislature</span></h1>
        {/* tabs */}
